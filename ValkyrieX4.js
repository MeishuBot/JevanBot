...
module.exports = Valkyrie = async (Valkyrie, mek) => {
  try {
    ...
    const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
      let po = Valkyrie.prepareMessageFromContent(from, { "listMessage": { "title": title, "description": desc, "buttonText": "SELECT", "footerText": "_*®Mecha Senku*_", "listType": "SINGLE_SELECT", "sections": list } }, {})
...
ꪶ ཻུ۪۪ꦽꦼ̷ _*${prefix}thunder*_ix}thunder*_
...
メLord Pebri⁴̅⁰͍⁴̵
メLord Galih⁴̅⁰͍⁴
̵`, buttons: [{ buttonId: `${prefix}donasi`, buttonText: { displayText: 'メ Donasi' }, type: 1 }, { buttonId: `${prefix}sewabot`, buttonText: { displayText: 'メ Sewabot' }, type: 1 }], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: tamnel, contextInfo: { mentionedJid: [sender, owner] } }
        }, 'buttonsMessage')
        break
      case "astetick":
      case "videoanime":
      ...
      case 'waktu':
        ...
        if ((args[0]) == '1bulan') {
          ...
          Valkyrie.sendMessage(from, buttonMessagep, MessageType.buttonsMessage,
            { contextInfo: { "forwardingScore": 999, "isForwarded": true, 'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6283805897808@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': { "imageMessage": { "caption": `©KirBotz`, 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg') } } } })
        } else
          if ((args[0]) == '2bulan') {
            pay = `${harga2bulan}`
